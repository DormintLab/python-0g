...
def get_ca(name: Literal["inference", "ledger"]):
    if name == "inference":
        return os.environ.get("A0G_INFERENCE_CA",
                              "0x192ff84e5E3Ef3A6D29F508a56bF9beb344471f3")

    elif name == "ledger":
        return os.environ.get("A0G_LEDGER_CA",
                              "0x907a552804CECC0cBAeCf734E2B9E45b2FA6a960")
